...
def create_user(
    ...
    decoded_token: dict = Depends(authorize_current_user) # protects endpoint but logic for this endpoint needs to be confirmed and fixed
    ):
...
# def get_dashboard(user_id: str, decoded_token: dict = Depends(authorize_current_user)): #<- protected
