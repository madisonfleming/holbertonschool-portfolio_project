...
from app.api.schemas.users import CreateUser, UserResponse, UpdateUser #TODO:AH ADDED

from app.domain.exceptions import(
    InvalidChildNameError,
    UserNotFoundError,
    ChildNotFoundError,
    InvalidUserNameError, #TODO:AH ADDED 
    InvalidEmailError #TODO: AH ADDED
)
...
class MLBFacade:
    ...
    # <--- USER ---> #TODO: AH ADDED (all below sections)
    def create_user(
        self,
        request: CreateUser
    ):
