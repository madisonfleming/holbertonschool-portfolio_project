...
const UpdateChild = ({ child, trigger, setTrigger, updateChild }) => {
  ...
  const handleUpdateChild = async () => {
    ...
    try {
      ...
      setTrigger(false); // close popup
      toast.success("Child updated successfully."); // enable success message
    } catch (error) {
      toast.error(error.message); // enable user error message for Secondary attempting to update child
    }
  };
